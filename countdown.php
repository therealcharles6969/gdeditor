...
#trackBody, #indexBody, #wordBody, #conunBody, #numBody {
...
#main {
  ...
  background-image: url('https://gdcolon.com/assets/gdfont/bg.jpg');
...
#clockdiv {
  ...
  var HiNum = new Array(4) ;
  var HiUsed = new Array(4) ;
  var LoNum = new Array(20) ;
  var LoUsed = new Array(20) ;
  ...
  // Set HiNum & LoNum Arrays
  // SImple initialisation to start
  for(Count = 0; Count < 10 ; Count++)
  {
    LoNum[Count]=Count+1 ;
    LoUsed[Count]=0 ;
    LoNum[Count+10]=Count+1 ;
    LoUsed[Count+10]=0 ;
    if(Count < 4)
    {
     HiNum[Count]=25*(Count+1) ;
     HiUsed[Count]=0 ;
    }
  }
  // Now Jumble them up
  for(Count1=19; Count1>=0; Count1-=1 )
  {
    JumbleNum=Math.floor(Math.random()*(Count1+1)) ;
    TempArr[Count1]=LoNum[JumbleNum] ;
    for(Count2=JumbleNum;Count2<Count1;Count2++)
    {
      LoNum[Count2]=LoNum[Count2+1]
    }
  }
  for(Count=0;Count<20;Count++)
  {
    LoNum[Count]=TempArr[Count] ;
  }
  for(Count1=3;Count1>=0;Count1-=1)
  {
    JumbleNum=Math.floor(Math.random()*(Count1+1)) ;
    TempArr[Count1]=HiNum[JumbleNum] ;
    for(Count2=JumbleNum;Count2<Count1;Count2++)
    {
      HiNum[Count2]=HiNum[Count2+1]
    }
  }
  for(Count=0;Count<4;Count++)
  {
    HiNum[Count]=TempArr[Count] ;
  }

  function DisplayCecilValue()
  {
    //Show Cecil Value
    var Hunds=Math.floor(CecilValue / 100) ;
    var Tens=Math.floor((CecilValue - (Hunds * 100)) / 10) ;
    var Units=Math.floor(CecilValue - (Hunds * 100) - (Tens * 10)) ;
    document.Cecil100.src='images/'+Hunds+'seg.gif' ;
    document.Cecil100.alt=Hunds ;
    document.Cecil10.src='images/'+Tens+'seg.gif' ;
    document.Cecil10.alt=Tens ;
    document.Cecil1.src='images/'+Units+'seg.gif' ;
    document.Cecil1.alt=Units ;
      }

  function StartCecil()
  {
    document.Cecil100.src='images/cecil0.gif' ;
    document.Cecil100.alt='Random' ;
    document.Cecil10.src='images/cecil3.gif' ;
    document.Cecil10.alt='Random' ;
    document.Cecil1.src='images/cecil6.gif' ;
    document.Cecil1.alt='Random' ;
    document.getElementById('aStopCecil').style.visibility='visible' ;
    document.getElementById('divStopButt').style.backgroundPosition=0 ;
    ShowManChoice.style.visibility='hidden' ;
  }

  function StopCecil()
  {
    var Choice=Math.floor(Math.random()*899) ; // 0 - 898
    Choice = Choice + 101 ;                    // 101 - 999
    document.NumberForm.CecilValue.value = Choice ;
    document.getElementById('aStopCecil').style.visibility='hidden' ;
    document.getElementById('divStopButt').style.backgroundPosition='-45px' ;
    var Hunds=Math.floor(Choice / 100) ;
    var Tens=Math.floor((Choice - (Hunds * 100)) / 10) ;
    var Units=Math.floor(Choice - (Hunds * 100) - (Tens * 10)) ;
    document.Cecil100.src='images/'+Hunds+'seg.gif' ;
    document.Cecil100.alt=Hunds ;
    document.Cecil10.src='images/'+Tens+'seg.gif' ;
    document.Cecil10.alt=Tens ;
    document.Cecil1.src='images/'+Units+'seg.gif' ;
    document.Cecil1.alt=Units ;
    ShowSolve.style.visibility='visible' ;
  }

  function AddHiNum(Key)
  {
    ShowManChoice.style.visibility='hidden' ;
    if((CurrNum <= MaxNum)&&(HiUsed[Key]==0))
    {
      document.images[NumOffSet+CurrNum].src='images/'+HiNum[Key]+'.gif' ;
      document.images[NumOffSet+CurrNum].alt=HiNum[Key] ;
      document.images[CardOffSet+Key].src='images/bluecard.gif' ;
      document.images[CardOffSet+Key].alt='Blue' ;
      HiUsed[Key]=1 ;    // This one has been used
      CurrNum++ ;
      if(CurrNum==1)
      {
        document.NumberForm.QNumbers.value=HiNum[Key] ;
      }
      else
      {
        document.NumberForm.QNumbers.value=document.NumberForm.QNumbers.value+','+HiNum[Key] ;
      }
    }
    if(ManEntry==0)
    {                       // Normal Game
      if (CurrNum>MaxNum)
      {
//        ShowCecil.style.visibility='visible' ;
      }
    }
    else
    {                       // Manual Entry Game
      if((CurrCecil>MaxCecil)&&(CurrNum>MaxNum))
      {
        ShowSolve.style.visibility='visible' ;
      }
    }
  ...
  function AddLoNum(Key)
  {
    ShowManChoice.style.visibility='hidden' ;
    if((CurrNum <= MaxNum)&&(LoUsed[Key]==0))
    {
      document.images[NumOffSet+CurrNum].src='images/'+LoNum[Key]+'.gif';
      document.images[NumOffSet+CurrNum].alt=LoNum[Key];
      document.images[CardOffSet+Key+4].src='images/bluecard.gif' ;
      document.images[CardOffSet+Key+4].alt='Blue' ;
      LoUsed[Key]=1 ;    // This one has been used
      CurrNum++ ;
      if(CurrNum==1)
      {
        document.NumberForm.QNumbers.value=LoNum[Key] ;
      }
      else
      {
        document.NumberForm.QNumbers.value=document.NumberForm.QNumbers.value+','+LoNum[Key] ;
      }
    }
    if(ManEntry==0)
    {                       // Normal Game
...
//        ShowCecil.style.visibility='visible' ;
  ...
  function ShowManEntry()
  {
    ManEntry=1 ;
    // Set Cecil to blank
    document.images['Cecil100'].src='images/blankseg.gif' ;
    document.images['Cecil100'].alt='Blank' ;
    document.images['Cecil10'].src='images/blankseg.gif' ;
    document.images['Cecil10'].alt='Blank' ;
    document.images['Cecil1'].src='images/blankseg.gif' ;
    document.images['Cecil1'].alt='Blank' ;
    //Unscramble Numbers & Show
    for(Count=0; Count<10 ; Count++)
    {
      LoNum[Count]=Count+1 ;
      LoUsed[Count]=0 ;
      document.images[CardOffSet+Count+4].src='images/'+LoNum[Count]+'card.gif' ;
      document.images[CardOffSet+Count+4].alt=LoNum[Count] ;
      LoNum[Count+10]=Count+1 ;
      LoUsed[Count+10]=0 ;
      document.images[CardOffSet+Count+14].src='images/'+LoNum[Count+10]+'card.gif' ;
      document.images[CardOffSet+Count+14].alt=LoNum[Count+10] ;
      if(Count < 4)
      {
       HiNum[Count]=25*(Count+1) ;
       HiUsed[Count]=0 ;
       document.images[CardOffSet+Count].src='images/'+HiNum[Count]+'card.gif' ;
       document.images[CardOffSet+Count].alt=HiNum[Count] ;
      }
    }
    ShowManChoice.style.visibility='hidden' ;
    for(Count=0;Count<10;Count++)
    {
      document.images[CardOffSet+Count+24].src='images/Little'+Count+'seg.gif' ;
      document.images[CardOffSet+Count+24].alt=Count ;
    }
    ShowPickCecil.style.visibility='visible' ;
  }

  function AddCecil(CecNum)
  {
    if(CurrCecil<=MaxCecil)
    {
      if(CurrCecil==0)
      {
        document.images['Cecil100'].src='images/'+CecNum+'seg.gif' ;
        document.images['Cecil100'].alt=CecNum ;
        CecilValue=CecNum*100 ;
      }
      if(CurrCecil==1)
      {
        document.images['Cecil10'].src='images/'+CecNum+'seg.gif' ;
        document.images['Cecil10'].alt=CecNum ;
        CecilValue+=(CecNum*10) ;
      }
      if(CurrCecil==2)
      {
        document.images['Cecil1'].src='images/'+CecNum+'seg.gif' ;
        document.images['Cecil1'].alt=CecNum ;
        CecilValue+=(CecNum*1) ;
        document.NumberForm.CecilValue.value = CecilValue ;
      }
      CurrCecil++ ;
      if((CurrCecil>MaxCecil)&&(CurrNum>MaxNum))
      {
  ...
  function SolveIt() 
  { 
     document.NumberForm.TryHard.value=document.NumberForm.TryHard.value + 1 ; 
     document.NumberForm.submit('Solve') ; 
  } 
    
  function thanks()
  {
    // Just seeing how many people care...
    var xhttp = new XMLHttpRequest();
    xhttp.open("GET", "thanks.php", false);
    xhttp.send();
    alert('Thanks for being considerate. Stay safe..')
  }
...
<body id="numBody" onload="DisplayCecilValue()">
<div id="main" style="position:relative">
  <table id="MainPage" cellspacing="1" cellpadding="1" width="850px" border="0">
    <tbody><tr>
      <td id="head" colspan="3">
        <h1 style="margin-left:100px">Countdown</h1>
        
      </td>
    </tr>
    <tr>
      <td style="vertical-align:top">
        In the "Countdown" math game, players are given a target number and a set of six random numbers. Using addition, subtraction, multiplication, and division, the goal is to reach the target number (or get as close as possible) by combining the given numbers. Each number can only be used once, and players must work quickly to find the solution within a time limit. It’s a fun way to practice mental math!
      </td>
      <td style="width:500px">
        <div id="divCecil">
          <table id="Cecil" cellspacing="1" cellpadding="1" align="center" border="1" style="margin-top:11px">
            <tbody><tr>
              <td>
                <img name="Cecil100" alt="0" src="images/0seg.gif" align="middle" border="1">
              </td>
              <td>
                <img name="Cecil10" alt="0" src="images/0seg.gif" align="middle" border="1">
              </td>
              <td>
                <img name="Cecil1" alt="0" src="images/0seg.gif" align="middle" border="1">
              </td>
            </tr>
          </tbody></table>
        </div>
        <div id="divStopButt">
          <p><a id="aStopCecil" href="javascript:StopCecil()">Stop</a></p>
        </div>
        <br clear="all">
        <div align="center">
          <table id="Numbers" cellspacing="1" cellpadding="1" align="center" border="1">
            <tbody><tr>
              <td>
                <img name="Num0" alt="Blank" src="images/blueblank.gif" align="middle" border="1">
              </td>
              <td>
                <img name="Num1" alt="Blank" src="images/blueblank.gif" align="middle" border="1">
              </td>
              <td>
                <img name="Num2" alt="Blank" src="images/blueblank.gif" align="middle" border="1">
              </td>
              <td>
                <img name="Num3" alt="Blank" src="images/blueblank.gif" align="middle" border="1">
              </td>
              <td>
                <img name="Num4" alt="Blank" src="images/blueblank.gif" align="middle" border="1">
              </td>
              <td>
                <img name="Num5" alt="Blank" src="images/blueblank.gif" align="middle" border="1">
              </td>
            </tr>
          </tbody></table>
        </div>
        <div align="center">
        <form name="NumberForm" method="post" action="/countdown/numgame.php">
          <table id="ChoiceTable" cellspacing="1" cellpadding="1" align="center" border="0">
            <tbody><tr>
                          <td height="90" align="center" colspan="3">
                <div id="ShowPickNum" style="visibility:visible">
                <b>Select your numbers by clicking on the cards below:</b>
                <table id="PickHi" cellspacing="1" cellpadding="1" border="1">
                  <tbody align="center">
                  <tr>
                   <td><img name="HiNum0" alt="yellow" src="images/yelcard.gif" onclick="AddHiNum(0)" border="1"></td>
                   <td><img name="HiNum1" alt="yellow" src="images/yelcard.gif" onclick="AddHiNum(1)" border="1"></td>
                   <td><img name="HiNum2" alt="yellow" src="images/yelcard.gif" onclick="AddHiNum(2)" border="1"></td>
                   <td><img name="HiNum3" alt="yellow" src="images/yelcard.gif" onclick="AddHiNum(3)" border="1"></td>
                  </tr>
                </tbody>
                </table>
                <table id="PickLo1" cellspacing="1" cellpadding="1" border="1">
                  <tbody align="center">
                  <tr>
                   <td><img name="LoNum0" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(0)" border="1"></td>
                   <td><img name="LoNum1" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(1)" border="1"></td>
                   <td><img name="LoNum2" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(2)" border="1"></td>
                   <td><img name="LoNum3" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(3)" border="1"></td>
                   <td><img name="LoNum4" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(4)" border="1"></td>
                   <td><img name="LoNum5" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(5)" border="1"></td>
                   <td><img name="LoNum6" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(6)" border="1"></td>
                  </tr>
                  <tr>
                   <td><img name="LoNum7" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(7)" border="1"></td>
                   <td><img name="LoNum8" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(8)" border="1"></td>
                   <td><img name="LoNum9" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(9)" border="1"></td>
                   <td><img name="LoNum10" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(10)" border="1"></td>
                   <td><img name="LoNum11" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(11)" border="1"></td>
                   <td><img name="LoNum12" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(12)" border="1"></td>
                   <td><img name="LoNum13" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(13)" border="1"></td>
                  </tr>
                </tbody>
                </table>
                <table id="EnterNos" cellspacing="1" cellpadding="1" border="1">
                  <tbody align="center">
                  <tr>
                   <td><img name="LoNum14" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(14)" border="1"></td>
                   <td><img name="LoNum15" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(15)" border="1"></td>
                   <td><img name="LoNum16" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(16)" border="1"></td>
                   <td><img name="LoNum17" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(17)" border="1"></td>
                   <td><img name="LoNum18" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(18)" border="1"></td>
                   <td><img name="LoNum19" alt="yellow" src="images/yelcard.gif" onclick="AddLoNum(19)" border="1"></td>
                  </tr>
                </tbody>
                </table>
                </div>
            ...
            <tr>
                ...
                <div id="ShowPickCecil" style="visibility:hidden">
                <table id="EnterCecil" bgcolor="gray" cellspacing="1" cellpadding="1" border="0">
                  <tbody align="center">
                  <tr>
                   <td><img onclick="AddCecil('0')" alt="0" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('1')" alt="1" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('2')" alt="2" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('3')" alt="3" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('4')" alt="4" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('5')" alt="5" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('6')" alt="6" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('7')" alt="7" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('8')" alt="8" src="images/bluedot.gif"></td> 
                    <td><img onclick="AddCecil('9')" alt="9" src="images/bluedot.gif"></td> 
                  </tr>
                </tbody>
                </table>
                </div>
            ...
            <tr>
               <td align="center" width="200">
                <span id="ShowSolve" style="visibility:hidden"><input type="submit" value="Solve" name="Solve"></span>
               </td>
              <td align="center" width="250">
                <!--span id="ShowCecil" style="visibility:hidden">
                <b>Click here to start & stop Cecil</b><br>
                <input type="button" name="CecilButt" value="Cecil" onclick="Cecil()">
                </span-->
              </td>
              <td align="center">
                <span id="ShowManChoice" style="visibility:visible">
                <input type="button" value="Manual Entry" onclick="ShowManEntry()">
                </span>
              </td>
            </tr>
            <tr>
          ...
          <input type="hidden" name="CecilValue">
          <input type="hidden" name="QNumbers">
          <input type="hidden" name="TryHard" value="0">
          <!-- <input type="hidden" name="Solve" value="Solve"> -->
        </form>
        </div>
      </td>
      <td width="120" valign="top" align="left">
        <iframe src="timer.html" width="200" height="450"></iframe>
      </td>
    </tr>
  </tbody></table>
</div>
